...
def categorize_transaction(description):
    if "interac etrnsfr" in description:
        ...
        return "TFSA deposit"
    elif "de souza carval" in description:
        return "Global transaction"
    elif "medallion" in description:
        return "Rent Costs"
    elif '0005191230213233522' in description:
...
features = [" "] # What difference does it make if I write more categories here?? 
